 ...
 * 抽出対象のコンテンツタイプ
 */
export type ExtractableContentType = 'article' | 'paper' | 'patent' | 'product' | 'event' | 'recipe' | 'code' | 'table' | 'list' | 'general';
/**
 * 抽出結果の基底インターフェース
 */
 ...
 * ペイウォールの種類
 */
export type PaywallType = 'hard' | 'soft' | 'freemium' | 'registration' | 'subscription' | 'institutional';
/**
 * マルチモーダル抽出の設定
 */
