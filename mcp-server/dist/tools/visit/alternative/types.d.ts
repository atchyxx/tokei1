 ...
 * コンテンツ種別
 */
export type ContentType = 'scientific_paper' | 'patent' | 'news' | 'technical_doc' | 'general';
/**
 * 代替情報源の種類
 */
export type AlternativeSourceType = 'preprint' | 'open_access' | 'institutional_repository' | 'author_homepage' | 'archive' | 'related_source' | 'cache';
/**
 * 代替情報源の定義
 */
 ...
 * 識別子の種類
 */
export type IdentifierType = 'doi' | 'arxiv_id' | 'pmid' | 'pmcid' | 'isbn' | 'issn' | 'patent_number' | 'semantic_scholar_id' | 'unknown';
/**
 * コンテンツ検出結果
 */
