 ...
 * クエリ簡略化戦略クラス
 */
export class SimplifyStrategy {
    name = 'simplify';
    priority = 2;
    maxWords;
    constructor(maxWords = 3) {
    ...
    generateAlternatives(query) {
        ...
        // 重複除去
        const uniqueAlternatives = alternatives.filter((alt, index, self) => self.findIndex((a) => a.query === alt.query) === index);
