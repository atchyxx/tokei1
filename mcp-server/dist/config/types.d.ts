 ...
 * デフォルト多言語検索設定
 */
export declare const DEFAULT_MULTILINGUAL_SEARCH_CONFIG: Required<MultilingualSearchConfig>;
/**
 * ナレッジ継承設定 (v1.8.0)
 ...
 * デフォルトナレッジ継承設定
 */
export declare const DEFAULT_KNOWLEDGE_INHERITANCE_CONFIG: Required<KnowledgeInheritanceConfig>;
/**
 * ページ訪問リカバリー設定 (v1.10.0)
 ...
 * デフォルトページ訪問リカバリー設定
 */
export declare const DEFAULT_VISIT_RECOVERY_CONFIG: Required<VisitRecoveryConfig>;
/**
 * ドメイン辞書設定 (v1.15.0)
 ...
 * デフォルトv1.15.0機能設定
 */
export declare const DEFAULT_V115_FEATURES_CONFIG: Required<V115FeaturesConfig>;
